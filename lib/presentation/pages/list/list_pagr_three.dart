...
//
// class ListPageThree extends StatelessWidget {
//   final ListBloc _bloc = instance<ListBloc>();
//
//   ListPageThree({Key? key}) : super(key: key);
//
//   @override
...
//         children: [
//           BlocProvider(
//             create: (context) => _bloc..add(const GetListPoplarTwo(page: 1)),
...
//                 } else if (state is ListLoadedPopularTwo) {
//                   return Column(
//                     children: [
